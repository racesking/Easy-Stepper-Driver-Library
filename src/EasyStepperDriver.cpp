...
//
easystepperdriver::easystepperdriver()
{
  //
...
//
void easystepperdriver::connectToPins(byte stepPinNumber, byte directionPinNumber)
{
  //
...
//
void easystepperdriver::setStepsPerMillimeter(float motorStepsPerMillimeter)
{
...
//
float easystepperdriver::getCurrentPositionInMillimeters()
{
...
// motor
//
void easystepperdriver::setCurrentPositionInMillimeters(
...
//            millimeters/second
//
void easystepperdriver::setSpeedInMillimetersPerSecond(float speedInMillimetersPerSecond)
{
...
//
void easystepperdriver::setAccelerationInMillimetersPerSecondPerSecond(
...
//
bool easystepperdriver::moveToHomeInMillimeters(long directionTowardHome,  
...
//
void easystepperdriver::moveRelativeInMillimeters(float distanceToMoveInMillimeters)
{
...
//          current position in millimeters
//
void easystepperdriver::setTargetPositionRelativeInMillimeters(
...
//
void easystepperdriver::moveToPositionInMillimeters(
...
//          move to in units of millimeters
//
void easystepperdriver::setTargetPositionInMillimeters(
                    float absolutePositionToMoveToInMillimeters)
{
...
//
float easystepperdriver::getCurrentVelocityInMillimetersPerSecond()
{
...
//
void easystepperdriver::setStepsPerRevolution(float motorStepPerRevolution)
{
...
//
float easystepperdriver::getCurrentPositionInRevolutions()
{
...
// motor
//
void easystepperdriver::setCurrentPositionInRevolutions(
...
//            revolutions/second
//
void easystepperdriver::setSpeedInRevolutionsPerSecond(float speedInRevolutionsPerSecond)
{
...
//
void easystepperdriver::setAccelerationInRevolutionsPerSecondPerSecond(
...
//  Exit:   true returned if successful, else false
//
bool easystepperdriver::moveToHomeInRevolutions(long directionTowardHome,  
...
//
void easystepperdriver::moveRelativeInRevolutions(float distanceToMoveInRevolutions)
{
...
//
void easystepperdriver::setTargetPositionRelativeInRevolutions(
...
//
void easystepperdriver::moveToPositionInRevolutions(
...
//          move to in units of revolutions
//
void easystepperdriver::setTargetPositionInRevolutions(
       float absolutePositionToMoveToInRevolutions)
{
...
//  Exit:  velocity speed in steps per second returned, signed
//
float easystepperdriver::getCurrentVelocityInRevolutionsPerSecond()
{
...
//
void easystepperdriver::setCurrentPositionInSteps(long currentPositionInSteps)
{
...
//
long easystepperdriver::getCurrentPositionInSteps()
{
...
//
void easystepperdriver::setSpeedInStepsPerSecond(float speedInStepsPerSecond)
{
...
//          steps/second/second
//
void easystepperdriver::setAccelerationInStepsPerSecondPerSecond(
...
//  Exit:   true returned if successful, else false
//
bool easystepperdriver::moveToHomeInSteps(long directionTowardHome,  
...
//          position in steps
//
void easystepperdriver::moveRelativeInSteps(long distanceToMoveInSteps)
{
...
//            positionin steps
//
void easystepperdriver::setTargetPositionRelativeInSteps(long distanceToMoveInSteps)
{
...
//            in unitsof steps
//
void easystepperdriver::moveToPositionInSteps(long absolutePositionToMoveToInSteps)
{
...
//            in units of steps
//
void easystepperdriver::setTargetPositionInSteps(long absolutePositionToMoveToInSteps)
{
...
// or revolutions
//
void easystepperdriver::setTargetPositionToStop()
{
...
//           position yet
//
bool easystepperdriver::processMovement(void)
{ 
...
//  Exit:  velocity speed in steps per second returned, signed
//
float easystepperdriver::getCurrentVelocityInStepsPerSecond()
{
...
//
bool easystepperdriver::motionComplete()
{
  if ((directionOfMotion == 0) && 
...
//
void easystepperdriver::DeterminePeriodOfNextStep()
{
  long distanceToTarget_Signed;
